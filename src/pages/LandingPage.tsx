...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#1A1714] text-[#F5F0EB] font-sans overflow-x-hidden">

      {/* ─── NAV ─── */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-[#1A1714]/80 border-b border-[#2A2520]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #C9963B, #E8B960)' }}>
              <Scissors className="w-5 h-5 text-[#1A1714]" />
            </div>
            <span className="font-bold text-xl tracking-tight text-white">Navalha</span>
          </div>
          <div className="hidden md:flex items-center gap-8">
            <a href="#servicos" className="text-sm text-[#A09888] hover:text-white transition-colors">Serviços</a>
            <a href="#como-funciona" className="text-sm text-[#A09888] hover:text-white transition-colors">Como funciona</a>
            <a href="#depoimentos" className="text-sm text-[#A09888] hover:text-white transition-colors">Depoimentos</a>
      ...
      <section className="relative min-h-screen flex items-center pt-20">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#1A1714] via-[#1A1714]/90 to-[#1A1714]/40" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-[#A09888] mb-10 max-w-lg leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                className="flex items-center justify-center gap-2 text-base font-medium px-8 py-4 rounded-xl border border-[#3A3530] text-[#A09888] hover:border-[#C9963B]/50 hover:text-white transition-all"
              >
                Ver demonstração
              </button>
            </div>
            ...
            {/* Social proof */}
            <div className="flex items-center gap-6 mt-12 pt-8 border-t border-[#2A2520]">
              <div className="flex -space-x-3">
                {[0, 1, 2, 3].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-[#1A1714] flex items-center justify-center text-xs font-bold" style={{ background: `hsl(${35 + i * 8}, 60%, ${45 + i * 5}%)`, color: '#1A1714' }}>
                    {['R', 'C', 'J', 'M'][i]}
                  </div>
                ))}
              </div>
              <div>
                ...
                <p className="text-xs text-[#A09888]">+2.500 profissionais confiam na Navalha</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-[#252118]/80 backdrop-blur-md border border-[#3A3530] rounded-2xl p-6 max-w-sm shadow-2xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-[#C9963B] flex items-center justify-center text-[#1A1714] font-bold">
              ...
              <div className="border-t border-[#3A3530] pt-4">
                <p className="text-xs font-bold text-[#A09888] mb-2 uppercase tracking-widest">Avaliação</p>
                ...
                <p className="text-sm text-[#A09888] mt-3 leading-relaxed">
      ...
      {/* ─── STATS BAR ─── */}
      <section className="border-y border-[#2A2520] bg-[#1E1B17]">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            <motion.div key={i} {...fadeUp(i * 0.05)} className="text-center">
              ...
              <p className="text-sm text-[#A09888] mt-2 font-medium">{s.label}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      {/* ─── SERVICES ─── */}
      <section id="servicos" className="py-24 bg-[#1A1714]">
              ...
              <motion.div key={i} {...fadeUp(i * 0.08)} className="group relative rounded-2xl overflow-hidden cursor-pointer">
                <div className="aspect-[4/5] relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <p className="text-sm text-[#A09888]">{svc.desc}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      {/* ─── HOW IT WORKS ─── */}
      <section id="como-funciona" className="py-24 bg-[#1E1B17]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <motion.div key={i} {...fadeUp(i * 0.1)} className="relative group">
                <div className="text-8xl font-black text-[#2A2520] absolute -top-4 -left-2 group-hover:text-[#C9963B]/10 transition-colors">{step.num}</div>
                <div className="relative pt-12">
                  ...
                  <p className="text-sm text-[#A09888] leading-relaxed">{step.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-24 bg-[#1A1714]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeUp()} className="text-center mb-16">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#C9963B] mb-4">Por que escolher a Navalha</p>
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div key={i} {...fadeUp(i * 0.04)} className="bg-[#1E1B17] border border-[#2A2520] rounded-2xl p-6 hover:border-[#C9963B]/30 transition-all group">
                ...
                <p className="text-sm text-[#A09888] leading-relaxed">{feat.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* ─── TESTIMONIALS ─── */}
      <section id="depoimentos" className="py-24 bg-[#1E1B17]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeUp()} className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <motion.div key={i} {...fadeUp(i * 0.08)} className="bg-[#1A1714] border border-[#2A2520] rounded-2xl p-8 relative">
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-[#A09888] leading-relaxed mb-6">"{t.text}"</p>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#C9963B] to-[#8A6520] flex items-center justify-center text-sm font-bold text-[#1A1714]">
                      {t.name.charAt(0)}
                    </div>
                    <div>
      ...
      {/* ─── PRICING ─── */}
      <section id="planos" className="py-24 bg-[#1A1714]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeUp()} className="text-center mb-16">
            ...
            <p className="mt-4 text-[#A09888]">7 dias de trial gratuito. Sem cartão de crédito.</p>
          </motion.div>
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {/* Starter */}
            <motion.div {...fadeUp(0)} className="bg-[#1E1B17] border border-[#2A2520] rounded-2xl p-8 hover:border-[#C9963B]/30 transition-all">
              <p className="font-bold text-sm text-[#A09888] mb-2">Starter</p>
              ...
              <ul className="space-y-3 mb-8">
                {['1 Profissional', 'Agenda ilimitada', 'Link de agendamento público', 'Suporte por e-mail'].map(f => (
                  <li key={f} className="flex items-center gap-3 text-sm text-[#A09888]">
              ...
              <button
                onClick={() => navigate('/cadastro')}
                className="w-full py-3.5 rounded-xl font-bold text-sm border border-[#3A3530] text-white hover:border-[#C9963B]/50 transition-all"
              >
                Iniciar Trial
              </button>
            </motion.div>
            ...
            {/* Growth */}
            <motion.div {...fadeUp(0.08)} className="relative bg-gradient-to-b from-[#252118] to-[#1E1B17] border border-[#C9963B]/30 rounded-2xl p-8 shadow-[0_0_40px_rgba(201,150,59,0.08)]">
              <div className="absolute top-5 right-5 text-xs font-bold px-3 py-1 rounded-full bg-gradient-to-r from-[#C9963B] to-[#E8B960] text-[#1A1714]">
                Mais popular
              </div>
      ...
      {/* ─── FINAL CTA ─── */}
      <section className="py-28 bg-[#1E1B17] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          <motion.div {...fadeUp()}>
            ...
            <p className="text-[#A09888] mb-10 max-w-lg mx-auto leading-relaxed">
      ...
      <footer className="bg-[#141210] border-t border-[#2A2520]">
        ...
        <div className="max-w-7xl mx-auto px-6 pb-8 pt-4 border-t border-[#2A2520] text-center text-xs text-[#444]">
          © {new Date().getFullYear()} Navalha SaaS. Todos os direitos reservados.
        </div>
      </footer>
    </div>
  );
